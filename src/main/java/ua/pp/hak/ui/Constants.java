...
public interface Constants {
	...
	final String defaultParameters = "AccTree=-1";
	...
	final String shortcutsText = "<html> <head> <style>table{border-collapse: collapse;}th, td{text-align: left; border-bottom: 1px solid #dddddd;}td.right{border-right: 1px solid #E03134;}tr:hover{background-color:#f5f5f5}tr.header{background-color: #E03134; color: white; font-weight: bold;}body{font-family:Segoe UI; font-size:9px;}div{background-color: white; padding:5px;}</style> </head> <body> <div> <table width='682'> <tbody><tr class='header'><td width='203'>Action</td><td width='131'>Shortcuts</td><td width='203'>Action</td><td width='131'>Shortcuts</td></tr><tr><td>Clipboard History</td><td class='right'>Ctrl+Shift+V</td><td>Select Down</td><td>Shift+DOWN</td></tr><tr><td>Comment lines</td><td class='right'>Ctrl + /</td><td>Select Forward</td><td>Shift+RIGHT</td></tr><tr><td>Copy</td><td class='right'>Ctrl+C or Ctrl+INSERT</td><td>Select Line End</td><td>Shift+END</td></tr><tr><td>Copy Line Down</td><td class='right'>Ctrl+Alt+DOWN</td><td>Select Line Start</td><td>Shift+HOME</td></tr><tr><td>Copy Line Up</td><td class='right'>Ctrl+Alt+UP</td><td>Select Next Word</td><td>Ctrl+Shift+RIGHT</td></tr><tr><td>Cut</td><td class='right'>Ctrl+X</td><td>Select Page Down</td><td>Shift+PAGE_DOWN</td></tr><tr><td>Delete Line</td><td class='right'>Ctrl+D</td><td>Select Page Left</td><td>Ctrl+Shift+PAGE_UP</td></tr><tr><td>Delete Previous Char</td><td class='right'>Shift+BACK_SPACE</td><td>Select Page Right</td><td>Ctrl+Shift+PAGE_DOWN</td></tr><tr><td>Delete Previous Word</td><td class='right'>Ctrl+BACK_SPACE</td><td>Select Page Up</td><td>Shift+PAGE_UP</td></tr><tr><td>Delete to End of Line</td><td class='right'>Ctrl+DELETE</td><td>Select Previous Word</td><td>Ctrl+Shift+LEFT</td></tr><tr><td>Find Next</td><td class='right'>Ctrl+K</td><td>Select Text End</td><td>Ctrl+Shift+END</td></tr><tr><td>Find Previous</td><td class='right'>Ctrl+Shift+K</td><td>Select Text Start</td><td>Ctrl+Shift+HOME</td></tr><tr><td>Insert Break</td><td class='right'>ENTER or Shift+ENTER</td><td>Select Up</td><td>Shift+UP</td></tr><tr><td>Join Lines</td><td class='right'>Ctrl+J</td><td>Text End</td><td>Ctrl+END</td></tr><tr><td>Line End</td><td class='right'>END</td><td>Text Start</td><td>Ctrl+HOME</td></tr><tr><td>Line Start</td><td class='right'>HOME</td><td>To Lower Case</td><td>Ctrl+Shift+Y</td></tr><tr><td>Move Line Down</td><td class='right'>Alt+DOWN</td><td>To Upper Case</td><td>Ctrl+Shift+X</td></tr><tr><td>Move Line Up</td><td class='right'>Alt+UP</td><td>Toggle Overwrite</td><td>INSERT</td></tr><tr><td>Next Word</td><td class='right'>Ctrl+RIGHT</td><td>Undo</td><td>Ctrl+Z</td></tr><tr><td>Paste</td><td class='right'>Ctrl+V or Shift+INSERT</td><td>Word Completion</td><td>Ctrl+Space</td></tr><tr><td>Previous Word</td><td class='right'>Ctrl+LEFT</td><td>Zoom Default</td><td>Ctrl+0</td></tr><tr><td>Redo</td><td class='right'>Ctrl+Y</td><td>Zoom In</td><td>Ctrl+=</td></tr><tr><td>Select All</td><td class='right'>Ctrl+A</td><td>Zoom Out</td><td>Ctrl+-</td></tr><tr><td>Select Backward</td><td class='right'>Shift+LEFT</td><td>&nbsp;</td><td>&nbsp;</td></tr></tbody> </table> </div></body></html>";
