...
//---------------------------
		...
		layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {findNextButton, replaceButton, replaceAllButton, cancelButton});
		setLayout(layout);
...
//		});
		...
		cancelButton.getInputMap(jta.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), "press_close_dialog_window");
