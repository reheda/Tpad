#!/usr/local/bin/perl
#
# create_templex_xml.pl - Generates the XML API file for RSyntaxTextArea from templex.txt
#
# Usage:
#     perl create_templex_xml.pl
#
use strict;
use Cwd qw(abs_path);
use File::Basename;
...
<!--
   templex.xml - API specification for the Templex Standard Library.
